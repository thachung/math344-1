...
},
{
  ...
  "number": "1.3.4",
  "title": "Metric balls.",
  "body": " Metric balls   Let be a metric ball in the metric space . If , there is a such that . In other words, for all elements of a metric ball , we can find a metric ball centered at contained in .   "
},
{
  "id": "proof-8",
  "level": "2",
  "url": "s_metric1.html#proof-8",
  "type": "Proof",
  "number": "1.3.1",
  "title": "",
  "body": " Since , we have and hence . We claim that . Indeed, we have . It follows that , proving .  "
},
{
  "id": "example-21",
  "level": "2",
  ...
  "body": " Metric balls for Euclidean and box metrics   Describe the metric balls for the Euclidean and box metrics on for .       "
},
{
  ...
  "number": "6",
  "title": "Metric spaces.",
  "body": " Metric spaces  Let be a metric space. The set of all metric balls is a topological basis, giving the structure of a topological space. We say the topology generated by the topology is induced by the metric .  With respect to this topology we have .   We must prove (1) that is a basis, and (2) that the description of openness in ( ) is correct. (The description in ( ) follows directly from ( ).)    For all , we have , proving the first axiom.      Comparing metric topologies   Let be two metrics on the set , and let be the topologies they induce.   We have if and only if every -metric ball is a union of -metric balls.    We have if and only if every -metric ball is a union of -metric balls and every -metric ball is a union of -metric balls.       "
},
{
  ...
  "body": " Equivalence of Euclidean, box, and taxicab metrics   Let . Show that the Euclidean, box, and taxicab metrics all induce the same topology on .       "
},
{
  "id": "d_trivial_metric",
  "level": "2",
...
},
{
  ...
  "body": " Trivial metric   Determine the topology induced on a set by the trivial metric.       "
},
{
  "id": "d_padic_metric",
  "level": "2",
