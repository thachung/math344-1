...
},
{
  ...
  "body": " Equivalent alternative to axiom (2)   Axiom (2) in is equivalent to saying that is equal to a union of elements of . In other words, we could replace (2) with the equivalent statement . This is a consequence of the following more general fact: let be a subset of , and let be a collection of subsets of ; we have for some if and only if for all there exists an element such that . I'll leave the proof of this to you.   "
},
{
  "id": "eg_basis_R",
  "level": "2",
...
},
{
  ...
  "body": " Bases for discrete topology   Let be a set, and let be the discrete topology on . Show the following:    is a basis for .    If is a basis for , then . In other words, is the minimal basis of the discrete topology.          "
},
{
  "id": "d_top_generated",
  "level": "2",
  "url": "s_bases_top.html#d_top_generated",
  "type": "Definition",
  "number": "1.2.13",
  "title": "Topology generated by a collection of subsets.",
  "body": " Topology generated by a collection of subsets   Let be a set, and let be a collection of subsets of . The topology generated by is the coarsest topology on containing . In more detail, is the unique topology on satisfying the following:    .    If is a topology and , then .      "
},
{
  "id": "th_top_generated",
  "level": "2",
  "url": "s_bases_top.html#th_top_generated",
  "type": "Theorem",
  "number": "1.2.14",
  "title": "",
  "body": "  Let be a set, and let be a collection of subsets of .   There is a unique topology generated by in the sense of .    In fact, we have , where is the collection of all topologies on containing .       First we show that there is at most one topology generated by in the sense of . Indeed if and both satisfy the conditions of , then both topologies contain ; and since both topologies are the coarsest topologies satisfying this property, we have and . It follows that .  Now we show that there is such a topology. Note first that the collection is nonempty, since is a topology (the discrete topology) containing , and thus the intersection is nonempty. Now, by simple properties of intersection it follows that satisfies for any topology containing . Furthermore, since is contained in for all , it is also contained in , the intersection of the . Thus the proof is complete if we can show that is in fact a topology. This in turn follows from the general fact that an intersection of topologies is a topology, the proof of which is left as an exercise.   "
},
{
  "id": "s_metric1",
  "level": "1",
  ...
  "number": "1.3",
  "title": "Metric spaces",
  "body": " Metric spaces   In this section we introduce a special family of topological spaces: metric spaces . These types of spaces are pervasive throughout mathematics and are conceptually very familiar or intuitive, as their defining structure, a metric  , is a straightforward generalization of the distance function defined in .    Metric space  A metric space is a pair , where is a set and is a function satisfying the following axioms:   Positivity   , and if and only if , for all .    Symmetry   for all .    Triangle inequality   for all .   The function is called a metric or a distance function on , and for any we call the distance between  and .    Euclidean and box metrics   Let , where is a positive integer. Let .   The function defined as is a metric, called the Euclidean metric . The metric space is called Euclidean -space . The norm of , denoted , is defined as .    The function defined as is a metric, called the box metric (or square metric ).          It is easiest to prove that the Euclidean metric is indeed a metric by first expressing it in terms of the dot product as and then using well-known properties of the dot product, including the Cauchy-Schwarz inequality.    Let be the box metric. It is clear that for all . Furthermore, we have . This proves positivity. The symmetry follows easily from the fact that . As for the triangle inequality, for all we have , where the leftmost inequality is the triangle inequality for the absolute value, and the rightmost inequality follows from the definition of . Since the inequality holds for all , we conclude that .        Metric balls   Let be a metric space. Given and the -ball centered at is the subset defined as . In other words, is the set of all elements of lying within a distance of of . We call a subset a metric ball if for some and .     Metric spaces  Let be a metric space. The set of all metric balls is a topological basis, giving the structure of a topological space. We say the topology generated by the topology is induced by the metric .  With respect to this topology we have .    "
},
{
  "id": "d_metric_space",
  "level": "2",
...
},
{
  ...
  "type": "Definition",
  "number": "1.3.2",
  "title": "Euclidean and box metrics.",
  "body": " Euclidean and box metrics   Let , where is a positive integer. Let .   The function defined as is a metric, called the Euclidean metric . The metric space is called Euclidean -space . The norm of , denoted , is defined as .    The function defined as is a metric, called the box metric (or square metric ).          It is easiest to prove that the Euclidean metric is indeed a metric by first expressing it in terms of the dot product as and then using well-known properties of the dot product, including the Cauchy-Schwarz inequality.    Let be the box metric. It is clear that for all . Furthermore, we have . This proves positivity. The symmetry follows easily from the fact that . As for the triangle inequality, for all we have , where the leftmost inequality is the triangle inequality for the absolute value, and the rightmost inequality follows from the definition of . Since the inequality holds for all , we conclude that .      "
},
{
  "id": "d_epsilon_balls",
  "level": "2",
  ...
  "number": "1.3.3",
  "title": "Metric balls.",
  "body": " Metric balls   Let be a metric space. Given and the -ball centered at is the subset defined as . In other words, is the set of all elements of lying within a distance of of . We call a subset a metric ball if for some and .   "
},
{
  ...
  "number": "6",
  "title": "Metric spaces.",
  "body": " Metric spaces  Let be a metric space. The set of all metric balls is a topological basis, giving the structure of a topological space. We say the topology generated by the topology is induced by the metric .  With respect to this topology we have .   "
},
{
